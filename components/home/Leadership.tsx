...
export const Leadership = () => {
  // Use interesection observer hook to trigger squggle animation
  const { setRef, visible } = useIntersect({ threshold: 0.7 });
  ...
  return (
    <Grid>
      ...
      <GridSquiggle ref={setRef}>
        <Squiggle visible={visible} />
      </GridSquiggle>
    </Grid>
  );
};
